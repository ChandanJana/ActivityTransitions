package janac.com.activitytransitions;
...
public class TransitionsActivity1 extends Activity implements View.OnClickListener {
    ...
    Context context;
    FrameLayout fade_in_button, fade_out_button, slide_down_button, slide_up_button,
            slide_from_left_button, slide_from_right_button;
    ...
    public void initializeViews() {
        fade_in_button = (FrameLayout) findViewById(R.id.fade_in);
        fade_in_button.setOnClickListener(this);

        fade_out_button = (FrameLayout) findViewById(R.id.fade_out);
        fade_out_button.setOnClickListener(this);

        slide_down_button = (FrameLayout) findViewById(R.id.slide_down);
        slide_down_button.setOnClickListener(this);

        slide_up_button = (FrameLayout) findViewById(R.id.slide_up);
        slide_up_button.setOnClickListener(this);

        slide_from_left_button = (FrameLayout) findViewById(R.id.slide_from_left);
        slide_from_left_button.setOnClickListener(this);

        slide_from_right_button = (FrameLayout) findViewById(R.id.slide_from_right);
